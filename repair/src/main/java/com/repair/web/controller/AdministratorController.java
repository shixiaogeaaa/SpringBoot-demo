...
import com.repair.entity.vo.AdministratorVO;
import com.repair.exception.AdministratorIdIsNullException;
import com.repair.exception.PageIsNullException;
import com.repair.service.AdministratorService;
import com.repair.utils.*;
...
/**
 * Created by SuperJJ on 2020/6/1 22:17
 */
@RestController
public class AdministratorController {
    ...
    public JsonResult login(String adminPhoneNum, String adminPassword) {
        ...
        Administrator admin = administratorService.searchAdministratorByPhoneNum(adminPhoneNum);
    ...
    public JsonResult getAllAdminInfo(String page) {
        ...
        String count = administratorService.countAllAdministrator();

        PageHelper.startPage(Integer.parseInt(page), ConstantUtils.Page.PAGESIZE);
        List<Administrator> list = administratorService.searchAllAdministrator();
    ...
    public JsonResult getAdminInfoById(String page, Integer id) {
        ...
        PageHelper.startPage(Integer.parseInt(page), ConstantUtils.Page.PAGESIZE);
        Administrator admin = administratorService.searchAdministratorById(id);
    ...
    public JsonResult getAdminInfoByName(String page, String adminName) {
        ...
        PageHelper.startPage(Integer.parseInt(page), ConstantUtils.Page.PAGESIZE);
        List<Administrator> adminList = (List<Administrator>) administratorService.searchAdministratorByName(adminName);
